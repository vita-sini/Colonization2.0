...
[RequireComponent(typeof(Scanner), typeof(BotSpawner))]
public class Base : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        _createBot = GetComponent<BotSpawner>();
    }
    ...
    private void CollectResource()
    {
        ...
        else
        {
            ...
            {
                Resource resource = availableResources.FirstOrDefault(resource => _resourceData.IsResourceBusy(resource) == false);
